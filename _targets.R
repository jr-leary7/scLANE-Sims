...
list(
  ...
  tar_target(scLANE_res_DEG_01_CELLS_2500, run_scLANE_reduced(sim.data = lung_sim_DEG_01_CELLS_2500,
                                                              n.genes.sample = 2300, 
                                                              n.iter = 1,
                                                              param.list = list(Prop_Dyn_Genes = 0.01, Cells = 2500),
                                                              n.cores = 4)),
  tar_target(scLANE_res_DEG_05_CELLS_2500, run_scLANE_reduced(sim.data = lung_sim_DEG_05_CELLS_2500,
                                                              n.genes.sample = 1000, 
                                                              n.iter = 1,
                                                              param.list = list(Prop_Dyn_Genes = 0.05, Cells = 2500),
                                                              n.cores = 8)),
  tar_target(scLANE_res_DEG_10_CELLS_2500, run_scLANE_reduced(sim.data = lung_sim_DEG_10_CELLS_2500,
                                                              n.genes.sample = 2400, 
                                                              n.iter = 1,
                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500),
                                                              n.cores = 4)),
  tar_target(scLANE_res_DEG_20_CELLS_2500, run_scLANE_reduced(sim.data = lung_sim_DEG_20_CELLS_2500,
                                                              n.genes.sample = 3200, 
                                                              n.iter = 1,
                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500),
                                                              n.cores = 4)),
  ...
  tar_target(tradeSeq_res_DEG_01_CELLS_2500, run_tradeSeq_reduced(sim.data = lung_sim_DEG_01_CELLS_2500, 
                                                                  n.genes.sample = 2100, 
                                                                  n.iter = 1, 
                                                                  param.list = list(Prop_Dyn_Gene = 0.01, Cells = 2500), 
                                                                  n.cores = 4)),
  tar_target(tradeSeq_res_DEG_05_CELLS_2500, run_tradeSeq_reduced(sim.data = lung_sim_DEG_05_CELLS_2500, 
                                                                  n.genes.sample = 3400, 
                                                                  n.iter = 1, 
                                                                  param.list = list(Prop_Dyn_Gene = 0.05, Cells = 2500), 
                                                                  n.cores = 4)),
  tar_target(tradeSeq_res_DEG_10_CELLS_2500, run_tradeSeq_reduced(sim.data = lung_sim_DEG_10_CELLS_2500, 
                                                                  n.genes.sample = 1400, 
                                                                  n.iter = 1, 
                                                                  param.list = list(Prop_Dyn_Gene = 0.10, Cells = 2500), 
                                                                  n.cores = 4)),
  tar_target(tradeSeq_res_DEG_20_CELLS_2500, run_tradeSeq_reduced(sim.data = lung_sim_DEG_20_CELLS_2500, 
                                                                  n.genes.sample = 1900, 
                                                                  n.iter = 1, 
                                                                  param.list = list(Prop_Dyn_Gene = 0.20, Cells = 2500), 
                                                                  n.cores = 4)),
  ...
  tar_target(scLANE_res_DEG_10_CELLS_2500_balanced, run_scLANE_reduced_GEE(sim.data = lung_sim_DEG_10_CELLS_2500_balanced,
                                                                           n.genes.sample = 1600, 
                                                                           n.iter = 1,
                                                                           param.list = list(Prop_Dyn_Genes = 0.1, Cells = 2500, Allocation = "balanced"),
                                                                           n.cores = 4)),
  tar_target(scLANE_res_DEG_20_CELLS_2500_balanced, run_scLANE_reduced_GEE(sim.data = lung_sim_DEG_20_CELLS_2500_balanced,
                                                                           n.genes.sample = 3500, 
                                                                           n.iter = 1,
                                                                           param.list = list(Prop_Dyn_Genes = 0.2, Cells = 2500, Allocation = "balanced"),
                                                                           n.cores = 4)),
  tar_target(scLANE_res_DEG_10_CELLS_2500_unbalanced, run_scLANE_reduced_GEE(sim.data = lung_sim_DEG_10_CELLS_2500_unbalanced,
                                                                             n.genes.sample = 2500, 
                                                                             n.iter = 1,
                                                                             param.list = list(Prop_Dyn_Genes = 0.1, Cells = 2500, Allocation = "unbalanced"),
                                                                             n.cores = 4)),
  tar_target(scLANE_res_DEG_20_CELLS_2500_unbalanced, run_scLANE_reduced_GEE(sim.data = lung_sim_DEG_20_CELLS_2500_unbalanced,
                                                                             n.genes.sample = 1000, 
                                                                             n.iter = 1,
                                                                             param.list = list(Prop_Dyn_Genes = 0.2, Cells = 2500, Allocation = "unbalanced"),
                                                                             n.cores = 4)), 
  ...
  tar_target(tradeSeq_res_DEG_10_CELLS_2500_balanced, run_tradeSeq_reduced_GEE(sim.data = lung_sim_DEG_10_CELLS_2500_balanced,
                                                                               n.genes.sample = 1900, 
                                                                               n.iter = 1,
                                                                               param.list = list(Prop_Dyn_Genes = 0.1, Cells = 2500, Allocation = "balanced"),
                                                                               n.cores = 4)),
  tar_target(tradeSeq_res_DEG_20_CELLS_2500_balanced, run_tradeSeq_reduced_GEE(sim.data = lung_sim_DEG_20_CELLS_2500_balanced,
                                                                               n.genes.sample = 1700, 
                                                                               n.iter = 1,
                                                                               param.list = list(Prop_Dyn_Genes = 0.2, Cells = 2500, Allocation = "balanced"),
                                                                               n.cores = 4)),
  tar_target(tradeSeq_res_DEG_10_CELLS_2500_unbalanced, run_tradeSeq_reduced_GEE(sim.data = lung_sim_DEG_10_CELLS_2500_unbalanced,
                                                                                 n.genes.sample = 2800, 
                                                                                 n.iter = 1,
                                                                                 param.list = list(Prop_Dyn_Genes = 0.1, Cells = 2500, Allocation = "unbalanced"),
                                                                                 n.cores = 4)),
  tar_target(tradeSeq_res_DEG_20_CELLS_2500_unbalanced, run_tradeSeq_reduced_GEE(sim.data = lung_sim_DEG_20_CELLS_2500_unbalanced,
                                                                                 n.genes.sample = 1600, 
                                                                                 n.iter = 1,
                                                                                 param.list = list(Prop_Dyn_Genes = 0.2, Cells = 2500, Allocation = "unbalanced"),
                                                                                 n.cores = 4)), 
