...
ggsave(filename = "QC_brain_reference.pdf",
       plot = p4b, 
       device = "pdf", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/QC_Plots/", 
       width = 13,
       height = 8, 
       units = "in", 
       dpi = "retina")
...
med_count <- ifelse(sparsity_count > 0.5, 0, median(panc_data_clean@assays$originalexp@counts))
...
med_count <- ifelse(sparsity_count > 0.5, 0, median(endo_data_clean@assays$originalexp@counts))
