---
title: "ENAR Conference Poster Figures"
...
metric_table %>% 
  filter(MODEL_TYPE != "scLANE (GEE)") %>% 
  ggplot(aes(x = MODEL_TYPE, y = RUNTIME_HOURS, fill = MODEL_TYPE)) + 
  facet_wrap(~DATASET_TYPE + N_CELLS, scales = "free_y") + 
  geom_violin(show.legend = FALSE, 
              draw_quantiles = 0.5, 
              size = 1, 
              scale = "width") + 
...
metric_table %>% 
  ...
  filter(MODEL_TYPE != "scLANE (GEE)") %>% 
  ggplot(aes(x = MODEL_TYPE, y = GENES_PER_MIN, fill = MODEL_TYPE)) + 
...
metric_table %>% 
  filter(MODEL_TYPE != "scLANE (GEE)") %>% 
  ggplot(aes(x = MODEL_TYPE, y = MEM_USED, fill = MODEL_TYPE)) + 
  facet_wrap(~DATASET_TYPE + N_CELLS, scales = "free_y") + 
  geom_violin(show.legend = FALSE, 
              draw_quantiles = 0.5, 
              size = 1, 
...
with_groups(metric_table ,
  ...
  kableExtra::kbl(digits = 3,
                  booktabs = TRUE, 
                  caption = "Memory used (MB)", 
                  col.names = c("Model", "Mean", "Median", "S.D.")) %>% 
  kableExtra::kable_classic(full_width = FALSE, "hover")
```

## Table of Other Metric Values
...
```{r}
# pdfs
ggsave(filename = "ENAR_Poster_Figure_1.pdf",
       plot = p9, 
       device = "pdf", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 20,
       height = 12, 
       units = "in", 
       dpi = "retina", 
       useDingbats = FALSE)
ggsave(filename = "ENAR_Poster_Figure_2.pdf",
       plot = p4, 
       device = "pdf", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 20,
       ...
       dpi = "retina", 
       useDingbats = FALSE)
ggsave(filename = "ENAR_Poster_Figure_3.pdf",
       plot = p11, 
       device = "pdf", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 14,
       ...
       useDingbats = FALSE)
# pngs
ggsave(filename = "ENAR_Poster_Figure_1.png",
       plot = p9, 
       device = "png", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 20,
       ...
       units = "in", 
       dpi = "retina")
ggsave(filename = "ENAR_Poster_Figure_2.png",
       plot = p4, 
       device = "png", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 20,
       ...
       units = "in", 
       dpi = "retina")
ggsave(filename = "ENAR_Poster_Figure_3.png",
       plot = p11, 
       device = "png", 
       path = "/blue/rbacher/j.leary/repos/scLANE-Sims/Figures/ENAR_Poster_Plots/", 
       width = 14,
