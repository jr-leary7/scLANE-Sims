...
list(
  ...
  ### MULTI-SUBJECT
  # 100 cells
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_100_balanced, 
                                                                              n.genes.sample = 2200, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_100_balanced, 
                                                                              n.genes.sample = 1000, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_100_unbalanced,
                                                                                n.genes.sample = 1600, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_100_unbalanced,
                                                                                n.genes.sample = 3100, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 500 cells
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_500_balanced, 
                                                                              n.genes.sample = 2200, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_500_balanced, 
                                                                              n.genes.sample = 1000, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_500_unbalanced,
                                                                                n.genes.sample = 1600, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_500_unbalanced,
                                                                                n.genes.sample = 3100, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 1000 cells
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_1000_balanced, 
                                                                               n.genes.sample = 1200, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_1000_balanced, 
                                                                               n.genes.sample = 1400, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_1000_unbalanced,
                                                                                 n.genes.sample = 2500, 
                                                                                 param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                 n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_1000_unbalanced,
                                                                                 n.genes.sample = 1800, 
                                                                                 param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                 n.cores = 4)),
  # 2500 cells
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_2500_balanced, 
                                                                               n.genes.sample = 2600, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_2500_balanced, 
                                                                               n.genes.sample = 2900, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_2500_unbalanced,
                                                                                 n.genes.sample = 2200, 
                                                                                 param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                 n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_2500_unbalanced,
                                                                                 n.genes.sample = 1700, 
                                                                                 param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                 n.cores = 4)),
  # 5000 cells
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_5000_balanced, 
                                                                               n.genes.sample = 3200, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_5000_balanced, 
                                                                               n.genes.sample = 1400, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_10_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_10_CELLS_5000_unbalanced,
                                                                                 n.genes.sample = 1600, 
                                                                                 param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                 n.cores = 4)),
  tar_target(scLANE_GLM_brain_DEG_20_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = brain_sim_DEG_20_CELLS_5000_unbalanced,
                                                                                 n.genes.sample = 2500, 
  ...
  ### MULTI-SUBJECT
  # 100 cells
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_100_balanced, 
                                                                             n.genes.sample = 2000, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_100_balanced, 
                                                                             n.genes.sample = 2400, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_100_unbalanced,
                                                                               n.genes.sample = 2100, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_100_unbalanced,
                                                                               n.genes.sample = 1300, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  # 500 cells
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_500_balanced, 
                                                                             n.genes.sample = 1800, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_500_balanced, 
                                                                             n.genes.sample = 1700, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_500_unbalanced,
                                                                               n.genes.sample = 2500, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_500_unbalanced,
                                                                               n.genes.sample = 2100, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  # 1000 cells
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_1000_balanced, 
                                                                              n.genes.sample = 1800, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_1000_balanced, 
                                                                              n.genes.sample = 1200, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_1000_unbalanced,
                                                                                n.genes.sample = 2300, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_1000_unbalanced,
                                                                                n.genes.sample = 3000, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 2500 cells
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_2500_balanced, 
                                                                              n.genes.sample = 2600, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_2500_balanced, 
                                                                              n.genes.sample = 2900, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_2500_unbalanced,
                                                                                n.genes.sample = 2200, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_2500_unbalanced,
                                                                                n.genes.sample = 1700, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 5000 cells
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_5000_balanced, 
                                                                              n.genes.sample = 3000, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_5000_balanced, 
                                                                              n.genes.sample = 2400, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_10_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_10_CELLS_5000_unbalanced,
                                                                                n.genes.sample = 1100, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_panc_DEG_20_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = panc_sim_DEG_20_CELLS_5000_unbalanced,
                                                                                n.genes.sample = 1400, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 5000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)), 
  ...
  ### MULTI-SUBJECT
  # 100 cells
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_100_balanced, 
                                                                             n.genes.sample = 1800, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_100_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_100_balanced, 
                                                                             n.genes.sample = 2400, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_100_unbalanced,
                                                                               n.genes.sample = 2100, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_100_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_100_unbalanced,
                                                                               n.genes.sample = 2700, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 100, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  # 500 cells
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_500_balanced, 
                                                                             n.genes.sample = 1500, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_500_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_500_balanced, 
                                                                             n.genes.sample = 1700, 
                                                                             param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Balanced", Method = "GLM"),
                                                                             n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_500_unbalanced,
                                                                               n.genes.sample = 3200, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.10, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_500_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_500_unbalanced,
                                                                               n.genes.sample = 1900, 
                                                                               param.list = list(Prop_Dyn_Genes = 0.20, Cells = 500, Allocation = "Unbalanced", Method = "GLM"),
                                                                               n.cores = 4)),
  # 1000 cells
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_1000_balanced, 
                                                                              n.genes.sample = 1300, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_1000_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_1000_balanced, 
                                                                              n.genes.sample = 1500, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_1000_unbalanced,
                                                                                n.genes.sample = 2300, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_1000_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_1000_unbalanced,
                                                                                n.genes.sample = 2600, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 1000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 2500 cells
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_2500_balanced, 
                                                                              n.genes.sample = 2600, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_2500_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_2500_balanced, 
                                                                              n.genes.sample = 1200, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_2500_unbalanced,
                                                                                n.genes.sample = 1200, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_2500_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_2500_unbalanced,
                                                                                n.genes.sample = 1700, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 2500, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  # 5000 cells
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_5000_balanced, 
                                                                              n.genes.sample = 2600, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_5000_balanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_5000_balanced, 
                                                                              n.genes.sample = 2200, 
                                                                              param.list = list(Prop_Dyn_Genes = 0.20, Cells = 5000, Allocation = "Balanced", Method = "GLM"),
                                                                              n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_10_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_10_CELLS_5000_unbalanced,
                                                                                n.genes.sample = 3200, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.10, Cells = 5000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)),
  tar_target(scLANE_GLM_endo_DEG_20_CELLS_5000_unbalanced, run_scLANE_GLM_multi(sim.data = endo_sim_DEG_20_CELLS_5000_unbalanced,
                                                                                n.genes.sample = 1800, 
                                                                                param.list = list(Prop_Dyn_Genes = 0.20, Cells = 5000, Allocation = "Unbalanced", Method = "GLM"),
                                                                                n.cores = 4)), 
